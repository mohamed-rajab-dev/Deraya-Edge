...
const STEP_ACCENTS = {
	'accent-blue': {
		box: 'bg-accent-blue/10',
		text: 'text-accent-blue',
	},
	'accent-emerald': {
		box: 'bg-accent-emerald/10',
		text: 'text-accent-emerald',
	},
	'accent-purple': {
		box: 'bg-accent-purple/10',
			...
			<div className='max-w-7xl mx-auto px-6 lg:px-12'>
				<div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
					<div>
						...
						<h2 className='font-bagel text-4xl sm:text-5xl text-foreground mb-10'>
							How It Works
						</h2>
							...
							{[
								{
									...
									d: 'Sign up with Google, Microsoft, or email to join the community.',
									c: 'accent-blue',
								},
								{
									n: '02',
									t: 'Complete Your Profile',
									d: 'Add your faculty, bio, and research interests.',
									c: 'accent-emerald',
								},
								{
									n: '03',
									t: 'Publish & Share',
									d: 'Upload research papers, write articles, or showcase projects.',
									c: 'accent-purple',
								},
							].map((step, i) => {
								const accent =
									STEP_ACCENTS[step.c as keyof typeof STEP_ACCENTS];
								...
								return (
									<motion.div
										...
										<div
											className={`w-12 h-12 ${accent.box} rounded-xl flex items-center justify-center flex-shrink-0`}>
											<span className={`${accent.text} font-black text-sm`}>
												{step.n}
											</span>
										</div>
										<div>
					...
					<motion.div
						...
						<div className='relative z-10'>
							<h3 className='font-bagel text-3xl text-foreground mb-4'>
								Ready to Publish?
							</h3>
							<p className='text-muted-foreground mb-8 max-w-md mx-auto'>
								Join our growing community of researchers and start sharing your
								academic work today.
							</p>
							{user ? (
								<a
