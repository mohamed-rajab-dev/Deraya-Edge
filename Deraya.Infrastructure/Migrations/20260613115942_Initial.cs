        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalAvatarUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AvatarProvider = table.Column<byte>(type: "tinyint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Profiles_MediaFiles_AvatarMediaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResearchFileId = table.Column<long>(type: "bigint", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, defaultValueSql: "SYSDATETIMEOFFSET()"),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    DeletedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResearchPapers_MediaFiles_ResearchFileId",
                        column: x => x.ResearchFileId,
                        principalTable: "MediaFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResearchPapers_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalSchema: "security",
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Profiles_AvatarMediaId",
                table: "Profiles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResearchPapers_OwnerId",
                table: "ResearchPapers",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_ResearchPapers_PublishedAt",
                table: "ResearchPapers",
                column: "PublishedAt");

            migrationBuilder.CreateIndex(
                name: "IX_ResearchPapers_ResearchFileId",
                table: "ResearchPapers",
                column: "ResearchFileId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_Users_Provider_ProviderUserId",
                schema: "security",
                table: "Users",
